...
const HeaderMain = () => {
  ...
  const cartItemsCount = cartItems.length > 0 ? cartItems.length : 0;

  return (
    <div className="fixed z-50 flex items-center justify-between w-full p-4 bg-white shadow-md">
      {user ? (
      ...
      <div className="flex gap-5">
        <div className="flex items-center gap-5">
          <span className="relative w-8">
            ...
            <span className="absolute top-0 right-0 flex items-center justify-center w-5 h-5 text-xs text-white bg-pink-600 rounded-full translate-x-2/4 translate-y-1/3">
              {cartItemsCount}
            </span>
          </span>
