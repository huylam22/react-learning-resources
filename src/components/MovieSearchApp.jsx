...
import useDebounceEvon from "../hooks/useDebounceEvon";
import LoadingSkeleton from "./loading/LoadingSkeleton";
// https://api.themoviedb.org/3/movie/550?api_key=f9d9b04b7918c3ef2fc42e47d96a6c9d
// https://api.themoviedb.org/3/search/movie?api_key=f9d9b04b7918c3ef2fc42e47d96a6c9d&query=''
  ...
  return (
    <div className="bg-white p-3 rounded-xl shadow-sm flex flex-col">
      ...
      <div className="p-7 flex-1 flex flex-col">
        <h3 className="text-xl text-black font-semibold mb-4 !leading-loose">
...
const MovieSearchApp = () => {
  ...
  const queryDebounce = useDebounceEvon(query, 500);
  useEffect(() => {
    async function fetchData() {
      setLoading(true);
      try {
        const response = await axios.get(
          `https://api.themoviedb.org/3/search/movie?api_key=f9d9b04b7918c3ef2fc42e47d96a6c9d&query=${queryDebounce}`
        );
  ...
  return (
    <div className="p-10">
      <div className="w-full max-w-[500px] mx-auto mb-20">
        <input
          type="text"
          className="w-full p-5 rounded-lg border border-purple-200 shadow-[0px_0px_0px_3px_rgba(125,_106,_255,_0.2)] focus:ring-purple-600 focus:ring-2 focus:outline-none"
